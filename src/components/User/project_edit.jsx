        ...
        <div className="grid">
            <div className="grid grid-cols-2 bg-yellow-50 p-6 rounded-lg mb-4">
                ...
                <div className="col-span-1 pr-2">
                    ...
                    {/* Project Title */}
                    <div className="mb-4">
                        <label htmlFor="editedTitle" className="block text-gray-700 text-sm font-bold mb-2">Project Title:</label>
                        <input
                            type="text"
                            id="editedTitle"
                            value={editedTitle}
                    ...
                    {/* Project Description */}
                    <div className="mb-4">
                        <label htmlFor="editedDescription" className="block text-gray-700 text-sm font-bold mb-2">Description:</label>
                        <textarea
                    ...
                    {/* Short Description */}
                    <div className="mb-4">
                        <label htmlFor="editedShortDescription" className="block text-gray-700 text-sm font-bold mb-2">Short Description:</label>
                        <textarea
                    ...
                    <div className="grid grid-cols-1 gap-y-1">
                        <div>
                            <p className="text-gray-700 font-bold mb-2">Project Type: {project.type}</p>
                            <p className="text-gray-700 font-bold mb-2">Project Status: {project.status}</p>
                            <p className='text-gray-700 font-bold mb-2'>Funding Goal: Rs. {project.funding_goal}</p>
                            <p className='text-gray-700 font-bold mb-2'>Funding Raised: Rs. {project.total_amount_raised}</p>
                            <p className='text-gray-700 font-bold mb-2'>Total Investors: {project.total_transactions} </p>
                        </div>
                        <div>
            ...
            <div className="bg-white rounded-lg mb-4 p-2">
                ...
                <div className="grid grid-cols-1 gap-4 bg-yellow-50 p-4 rounded-lg">
                    ...
                    {currentItems.map((update, index) => (
                        <div key={index} className="bg-yellow-50 p-4 rounded-lg shadow-md relative">
