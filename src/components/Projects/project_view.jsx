...
export default function Project_View() {
    ...
    return (
        <div className="container mx-auto px-4 py-8 div-yellow-50">
            <button onClick={CreateReport} className="absolute bg-red-500 hover:bg-red-600 text-white font-bold right-16 top-24 py-2 px-4 rounded">
                <span>Report</span>
            </button>
